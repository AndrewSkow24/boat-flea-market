...
class BoatHistory(models.Model):
    ...
    owner = models.ForeignKey(
        Owner, on_delete=models.SET_NULL, verbose_name="Владелец", **NULLABLE
    )

    start_year = models.PositiveSmallIntegerField(**NULLABLE, verbose_name="Владение с")
    stop_year = models.PositiveSmallIntegerField(**NULLABLE, verbose_name="Владение по")
